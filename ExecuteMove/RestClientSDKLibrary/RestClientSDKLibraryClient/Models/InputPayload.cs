...
namespace RestClientSDKLibrary.Models
{
    ...
    public partial class InputPayload
    {
        ...
        /// Initializes a new instance of the InputPayload class.
        /// </summary>
        public InputPayload(int? move = default(int?), string azurePlayerSymbol = default(string), string humanPlayerSymbol = default(string), IList<string> gameBoard = default(IList<string>), string message = default(string))
        {
            Move = move;
